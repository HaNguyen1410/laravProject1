                ...
                <form action="" method="post" >
                    <table class="table table-bordered" width="800px" cellpadding="15px" cellspacing="0px" id="bang1">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="txtMaCV" value="" class="form-control" readonly=""/>
                                <input type="hidden" name="txtMaCvChinh" value="" class="form-control"/>
                            </td>
                            <th width="10%">Tên công việc:</th>
                            <td colspan="3">
                                <input type="text" name="txtTenCV" value="" class="form-control" readonly=""/>
                            </td>
                        </tr>
                        <tr>
