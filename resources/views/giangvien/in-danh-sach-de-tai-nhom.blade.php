...
<html>
    <head>
        ...
        <title>In Danh Sách Đề Tài Nhóm</title>
        <style type="text/css">
            body { 
        ...
        @if($mahp == "all")
            @foreach($gv_hp as $gvhp)
                <div>
                    ...
                    <h2 align="center" style="margin-bottom: 1px;">DANH SÁCH ĐỀ TÀI NHÓM</h2>
                    <div align="center">
                    ...
                    <table border="1" style="width:100%; margin-left: -15px;" cellpadding="4px 8px" cellspacing="0px 0px">            
                        <tr>
                            ...
                            <th width="25%">Đề tài thực hiện</th>
                        </tr> 
                ...
                <!--                            <img src="public/images/tick-icon-small .png"/>                        -->
                    ...
                    <table border="0" style="width:300px;" align="right" padding="1px 1px" cellspacing="0px 0px">
                        ...
                        <tr>                
                            <td align="center">
                                <lable style="font-weight: bold; color: blue;">{{$nguoiin}} ({{$macb}})</lable>                
                            </td>
                        </tr>
                    </table>
                </div>
