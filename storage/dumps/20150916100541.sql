...
INSERT INTO `chia_nhom` VALUES ('1111222',6,' ',0,''),('1111223',6,' ',0,''),('1111271',6,'NTH01',0,''),('1111306',6,'NTH01',1,''),('1111308',6,'NTH02',0,''),('1111317',6,'NTH02',0,''),('1111324',6,'NTH02',1,''),('1111333',6,' ',0,''),('1111342',6,'NTH03',1,''),('1111359',6,'NTH01',0,''),('1111366',6,'',NULL,''),('1111432',6,'NTH04',1,''),('1113456',6,'NTH04',0,''),('1211234',6,'',0,''),('21321',6,' ',0,''),('21322',7,'',0,''),('21323',7,'',0,'');
...
INSERT INTO `danh_gia` VALUES ('TL01','',NULL,NULL),('TL02','',NULL,NULL),('TL03','',NULL,NULL),('TL04','',NULL,NULL),('TL05','',NULL,NULL),('TL06','',NULL,NULL),('TL07','2134','Nêu chi tiết hơn về kế hoạch phân công việc của mỗi thành viên trong nhóm','2015-09-16');
...
CREATE TABLE `quy_dinh` (
  ...
  CONSTRAINT `quy_dinh_ibfk_1` FOREIGN KEY (`matc`) REFERENCES `tieu_chi_danh_gia` (`matc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tieu_chi_danh_gia` VALUES ('1','Tính sáng tạo',1,'2014-06-30'),('2','Phần mềm dự án',5,'2014-06-30'),('3','Tài liệu dự án',4,'2014-06-30'),('4','Đánh giá về sự hoàn thành của dự án',2,'2015-09-16'),('5','Kỹ năng làm việc nhóm',1,'2015-09-16'),('6','Tài liệu báo cáo',3,'2015-09-16'),('7','Phần Demo dự án',2,'2015-09-16');
...
-- Dump completed on 2015-09-16 17:05:48
